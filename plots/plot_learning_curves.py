...
variant_group = [[swimmer_wd0, swimmer_wd5e5, swimmer_wd5e4, swimmer_wd5e3], [carla2d_wd]]
measures = ['NRC1', 'NRC2', 'NRC3_epoch']
legend_group = [[r'$\lambda_{WD}=0$', r'$\lambda_{WD}=5e-4$', r'$\lambda_{WD}=5e-3$', r'$\lambda_{WD}=5e-2$', r'$\lambda_{WD}=1e-2$'],
                [r'$\lambda_{WD}=0$', r'$\lambda_{WD}=5e-4$', r'$\lambda_{WD}=5e-3$', r'$\lambda_{WD}=5e-2$', r'$\lambda_{WD}=1e-2$']]
xlabel = 'Epoch'
...
# datasets = ['carla2d']
# variant_group = [[carla2d_wd]]
# measures = ['NRC1', 'NRC2', 'NRC3_epoch']
# legend_group = [['WD=0', 'WD=5E-4', 'WD=5E-3', 'WD=5E-2', 'WD=1E-1']]
# xlabel = 'Epoch'
# ylabel = ['NRC1', 'NRC2', 'NRC3']
# plot_multi_variants(datasets, variant_group, measures, legend_group,
#                     figsize=None,
