...
#SBATCH --array=0-31 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python main/exp/initiative/test.py --setting ${SLURM_ARRAY_TASK_ID}
"