...
python main/exp/case1/reproduce.py --setting ${SLURM_ARRAY_TASK_ID} # execute corresponding python file
...
#python main/exp/case1/reproduce.py --setting ${SLURM_ARRAY_TASK_ID}
#"