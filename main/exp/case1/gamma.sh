...
# #####################################################
#SBATCH --gres=gpu:rtx2080:1 # uncomment this line to request a gpu
#SBATCH --ntasks=3
...
singularity exec --nv -B /scratch/$USER/NC_regression:/NC_regression -B /scratch/$USER/cql-sandbox/opt/conda/lib/python3.8/site-packages/mujoco_py/:/opt/conda/lib/python3.8/site-packages/mujoco_py/ /scratch/$USER/cql-sandbox bash
cd /NC_regression
export PYTHONPATH=$PYTHONPATH:/NC_regression

srun --exclusive -N1 -n1 python main/exp/case1/gamma.py --setting 0 &
srun --exclusive -N1 -n1 python main/exp/case1/gamma.py --setting 1 &
srun --exclusive -N1 -n1 python main/exp/case1/gamma.py --setting 2 &
wait